class BookingsController < ApplicationController
  ...
  def new
    @booking = Booking.new(tennis_court_id: @tennis_court.id)
  end

  def create
    @booking =  Booking.new(params[:booking].permit(:tennis_court_id, :start_time, :length))
  ...
  def update
    @booking = Booking.find(params[:id])
    # @booking.tennis_courts = @tennis_courts
